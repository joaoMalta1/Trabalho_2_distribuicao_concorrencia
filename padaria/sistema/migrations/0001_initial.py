    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imgem', models.ImageField(blank=True, null=True, upload_to='produtos/')),
                ('distribuidor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
